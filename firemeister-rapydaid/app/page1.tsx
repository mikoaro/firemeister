...
import ProductPage from "@/components/product-card";
  ...
  return (
    <section className="flex flex-col min-h-screen">
      ...
      <main className="bg-gray-200">
        <section className="max-w-7xl py-20 mx-auto flex flex-col item-center justify-center h-[50vh]">
          <div className="px-4 sm:px-6 lg:px-8">
            <div className="">
              <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left bg-gray">
                <h1 className="text-7xl font-bold text-gray-900 tracking-tight sm:text-5xl md:text-6xl text-center">
                  Build Your SaaS
                  <span className="block text-orange-500 text-center">
                    Faster Than Ever
                  </span>
                </h1>
            ...
            <div className="flex justify-center text-center">
              <div>
                <div className="flex items-center justify-center h-12 w-12 rounded-md bg-orange-500 text-white mx-auto">
                  <svg viewBox="0 0 24 24" className="h-6 w-6 flex">
                    <path
                      fill="currentColor"
