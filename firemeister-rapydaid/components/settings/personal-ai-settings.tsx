...
import { PlusCircle, Trash2, Grid, List, Upload, BotIcon, FileText, AlertCircle, X } from "lucide-react"
...
export function PersonalAISettings() {
  const { avatars, setAvatars, selectedAgent, selectAgent, updateAvatar } = useAgent()
    ...
    const handleUpdateAvatar = (id: string, field: keyof (typeof avatars)[0], value: string) => {
    ...
    <div className="space-y-4 w-full">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure your Agent avatars and digital assistants.</CardDescription>
        </CardHeader>
            ...
            <div className="space-y-4">
                ...
                <TabsContent value="profile">
                  ...
                  <div className="space-y-2 mt-5">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleUpdateAvatar(currentAvatar.id, "name", e.target.value)}
                    />
                  </div>
                  <div className="space-y-2 mt-5">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleUpdateAvatar(currentAvatar.id, "role", e.target.value)}
                    />
                  </div>
                  <div className="space-y-2 mt-5">
                    ...
                    <Textarea
                      ...
                      onChange={(e) => handleUpdateAvatar(currentAvatar.id, "description", e.target.value)}
                    />
                  </div>
                  <Button
                    variant="destructive"
              ...
              <div className="space-y-4">
                      ...
                      <div className="text-sm text-muted-foreground space-y-1">
                        {selectedFiles.map((file, index) => (
                          <div key={index} className="flex items-center">
                            <span className="mr-2">
                              {getFileIcon(file.type || getFileType(file.name))}
                            </span>
                ...
                <div className="text-sm text-muted-foreground">
                  Upload documents specific to this AI avatar. These documents
                  will be used to train and inform this avatar&apos;s responses.
                </div>
              </div>
                  ...
                  <ScrollArea className="h-[300px]">
                    {currentAvatar.documents.length === 0 ? (
                      <div className="flex flex-col items-center justify-center h-[200px] text-muted-foreground">
                        ...
                        <p className="text-sm">
                          Upload documents to enhance this AI avatar&apos;s knowledge
                        </p>
                      </div>
                    ) : (
                        ...
                        {currentAvatar.documents.map((doc) => (
                          ...
                          >
                            ...
                            <Button
                              ...
                              size="icon"
                              onClick={() =>
                                handleDeleteDocument(currentAvatar.id, doc.id)
                              }
          ...
          {avatars.map((avatar) => (
            <Card
              ...
              className={`cursor-pointer transition-colors ${
                selectedAgent === avatar.id ? "border-primary" : "hover:bg-accent"
              }`}
